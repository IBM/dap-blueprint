...
locals {
  ...
  env = {
    ...
    "env" : {
      ...
      "RHSSO_HOST": "${var.PREFIX}-rhsso.${var.DNS_DOMAIN}",
      "DAP_HOST": "${var.PREFIX}-tp.${var.DNS_DOMAIN}",
      ...
      "TXQUEUE_SSH_PORT": var.TXQUEUE_SSH_PORT,
      "WALLETDB_SSH_PORT": var.WALLETDB_SSH_PORT,
      ...
      "TXQUEUE_HOST": "${var.PREFIX}-txqueue.${var.DNS_DOMAIN}",
      "TXQUEUE_PORT": var.TXQUEUE_PORT,
      "WALLETDB_HOST": "${var.PREFIX}-walletdb.${var.DNS_DOMAIN}",
      "WALLETDB_PORT": var.WALLETDB_PORT
    }
  }
  workload_template = {
    "type" : "workload",
