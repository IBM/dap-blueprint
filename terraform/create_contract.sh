...
TXQUEUE_TARGETS="-target local_file.txqueue_contract -target local_file.txqueue_contract_encrypted"
WALLETDB_TARGETS="-target local_file.walletdb_contract -target local_file.walletdb_contract_encrypted"

TARGETS="${RHSSO_TARGETS} ${TP_TARGETS} ${AP_TARGETS} ${FDP_TARGETS} ${TAP_TARGETS} ${SS_TARGETS} ${TXQUEUE_TARGETS} ${WALLETDB_TARGETS}"
