...
class CryptoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReencryptSingle = channel.unary_unary(
                '/grep11.Crypto/ReencryptSingle',
                request_serializer=server__pb2.ReencryptSingleRequest.SerializeToString,
                response_deserializer=server__pb2.ReencryptSingleResponse.FromString,
                )
        ...
        self.ReEncrypt = channel.unary_unary(
                '/grep11.Crypto/ReEncrypt',
                request_serializer=server__pb2.ReEncryptRequest.SerializeToString,
                response_deserializer=server__pb2.ReEncryptResponse.FromString,
                )
...
class CryptoServicer(object):
    ...
    def ReencryptSingle(self, request, context):
        """CK_RV m_ReencryptSingle (
        const unsigned char *decKey, size_t decKeylen,
...
def add_CryptoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReencryptSingle': grpc.unary_unary_rpc_method_handler(
                    servicer.ReencryptSingle,
                    request_deserializer=server__pb2.ReencryptSingleRequest.FromString,
                    response_serializer=server__pb2.ReencryptSingleResponse.SerializeToString,
            ),
            ...
            'ReEncrypt': grpc.unary_unary_rpc_method_handler(
                    servicer.ReEncrypt,
                    request_deserializer=server__pb2.ReEncryptRequest.FromString,
                    response_serializer=server__pb2.ReEncryptResponse.SerializeToString,
            ),
    }
...
class Crypto(object):
    ...
    def ReencryptSingle(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grep11.Crypto/ReencryptSingle',
            server__pb2.ReencryptSingleRequest.SerializeToString,
            server__pb2.ReencryptSingleResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ReEncrypt(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grep11.Crypto/ReEncrypt',
            server__pb2.ReEncryptRequest.SerializeToString,
            server__pb2.ReEncryptResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
